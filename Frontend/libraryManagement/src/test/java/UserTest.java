...
public class UserTest {
    ...
    public void testUserConstructorWithAllParams() {
        ...
        User user = new User("john_doe", "1234567890", "123-456-789", "john.doe@example.com", "USA", "California", "active", registeredDate);
    ...
    public void testUserCopyConstructor() {
        User originalUser = new User("alice_smith", "1122334455", "987-654-321", "alice.smith@example.com", "Canada", "Ontario", "inactive", LocalDateTime.of(2022, 5, 15, 12, 0, 0, 0));
        User copiedUser = new User(originalUser);

        assertEquals(originalUser.getUserName(), copiedUser.getUserName(), "User name should be copied");
        assertEquals(originalUser.getIdentityCard(), copiedUser.getIdentityCard(), "Identity card should be copied");
        assertEquals(originalUser.getPhoneNumber(), copiedUser.getPhoneNumber(), "Phone number should be copied");
        ...
        assertEquals(originalUser.getRegisteredDate(), copiedUser.getRegisteredDate(), "Registered date should be copied");
    }
    ...
    public void testToString() {
        User user = new User("carol_white", "987654321", "123-321-123", "carol.white@example.com", "Australia", "New South Wales", "active", LocalDateTime.of(2021, 7, 1, 9, 0, 0, 0));
    ...
    public void testSettersAndGetters() {
        ...
        assertEquals("david.lee@example.com", user.getEmail(), "Email should be 'david.lee@example.com'");
