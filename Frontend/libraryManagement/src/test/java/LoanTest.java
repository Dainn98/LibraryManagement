...
public class LoanTest {
    ...
    public void testGetRequiredReturnDateAsString() {
        ...
        assertTrue(requiredReturnDate.isAfter(loan.getDateOfBorrow()), "Required return date should be after borrow date.");
    }
    ...
    public void testGetDocumentInfoWhenDocumentNotFound() {
        ...
        assertEquals("N/A", loan.getPublisher(), "Publisher should be 'N/A' when document is not found.");
