...
public class DocumentTest {
    ...
    public void testSetAndGetCategoryID() {
        ...
        assertEquals("CAT456", document.getStringCategoryID(), "Category ID should be formatted correctly.");
    }

    @Test
    public void testSetAndGetPublisher() {
        document.setPublisher("Sample Publisher");
        assertEquals("Sample Publisher", document.getPublisher(), "Publisher should be correctly set and retrieved.");
    }
    ...
    public void testSetAndGetTitle() {
        ...
        assertEquals("Sample Document Title", document.getTitle(), "Title should be correctly set and retrieved.");
    }
    ...
    public void testSetAndGetIsbn() {
        ...
        assertEquals("978-3-16-148410-0", document.getIsbn(), "ISBN should be correctly set and retrieved.");
    }
    ...
    public void testSetAndGetAvailableCopies() {
        ...
        assertEquals(5, document.getAvailableCopies(), "Available copies should be correctly set and retrieved.");
    }
    ...
    public void testSetAddDate() {
        ...
        assertNotNull(document.getAddDate(), "Add date should be set correctly for a valid date format.");
    ...
    public void testSetAndGetDescription() {
        ...
        assertEquals("Sample document description.", document.getDescription(), "Description should be correctly set and retrieved.");
    }

    @Test
    public void testSetAndGetUrl() {
        document.setUrl("http://example.com");
        assertEquals("http://example.com", document.getUrl(), "URL should be correctly set and retrieved.");
    }

    @Test
    public void testSetAndGetImage() {
        document.setImage("http://example.com/image.jpg");
        assertEquals("http://example.com/image.jpg", document.getImage(), "Image URL should be correctly set and retrieved.");
    }

    @Test
    public void testSetAndGetAvailability() {
        document.setAvailability("Available");
        assertEquals("Available", document.getAvailability(), "Availability should be correctly set and retrieved.");
    }
}
