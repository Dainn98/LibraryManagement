...
/**
 * Data Access Object (DAO) class responsible for performing CRUD operations on the "category" table
 * in the database. This class provides methods for adding, deleting, updating, and retrieving
 * categories. It also provides utility methods to retrieve category tags and their corresponding
 * IDs.
 */
