...
/**
 * The {@code UserAvatarController} is responsible for managing the user's avatar and related
 * information in the user interface. It handles the initialization of the avatar component, which
 * includes loading and displaying additional user information.
 * <p>
 * This controller uses an FXML layout for the avatar view and interacts with other controllers to
...
public class UserAvatarController extends UserSubController implements properties {
  ...
  /**
   * Initializes the user avatar by loading the avatar information FXML view and adding it to the
   * provided {@code VBox} container. This method sets up the user avatar and any related
   * information within the given container.
   *
