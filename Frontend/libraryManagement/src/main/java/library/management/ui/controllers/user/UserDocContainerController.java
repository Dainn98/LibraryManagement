...
/**
 * The {@code UserDocContainerController} class handles the display and interaction with document
 * containers in the user interface. It shows document information such as title, author, and
 * description, and allows the user to interact with the document thumbnail.
 */
public class UserDocContainerController extends GeneralController implements properties {
  ...
  /**
   * Sets the data for the document container. This includes the document's thumbnail, title,
   * author, description, and the loan (if applicable).
   *
  ...
  /**
   * Handles mouse enter event on the document thumbnail. Rotates the document thumbnail and starts
   * an auto-rotate back after a pause.
   *
  ...
  /**
   * Handles mouse exit event on the document description. Rotates the document information back to
   * its original state.
   *
  ...
  /**
   * Handles the press event on the document container. Opens a new window displaying detailed
