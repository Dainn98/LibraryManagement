...
/**
 * Controller for handling the sign-out action in the Library Management System. This class is
 * responsible for loading the login screen and closing the current window when a user signs out of
 * the application.
 */
