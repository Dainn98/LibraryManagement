...
/**
 * The {@code UserAvatarInfoController} class handles the user avatar information UI, including
 * displaying user details and managing the theme toggle and settings button actions.
 * <p>
...
public class UserAvatarInfoController extends UserSubController implements properties {
  ...
  /**
   * Handles the theme toggle button action. When the toggle button is clicked, the UI theme is
  ...
  /**
   * Handles the settings button action. Opens the settings window where the user can modify
